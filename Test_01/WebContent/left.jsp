				...
				<table>
					<tr style="height: 210px;">
						...
						<c:if test="${course[0] ne null }">
				         <td style="width: 260px; height: 160px;"><a href="${APP_PATH}/upload/testVideo?cId=${course[0].cId}"><img
							  alt="加载失败" src="/images/${APP_PATH }/img/${course[0].cImg }.jpg" width="240px" height="140px"></a>
					         <br>${course[0].cName }
				        </td>
							...
							<c:if test="${course[1] ne null }">
								<td style="width: 260px; height: 160px;"><a href="${APP_PATH}//upload/testVideo?cId=${course[0].cId}"><img
										alt="加载失败" src="/images/${APP_PATH }/img/${course[1].cImg }.jpg"
						...
						<c:if test="${course[2] ne null }">
							<td style="width: 260px; height: 160px;"><div>
									<a href="${APP_PATH}//upload/testVideo?cId=${course[2].cId}">
									<img alt="加载失败" src="//images/${APP_PATH }/img/${course[2].cImg }.jpg"
					...
					<tr style="height: 200px;">
						...
						<c:if test="${course[3] ne null }">
							<td><a href="${APP_PATH}//upload/testVideo?cId=${course[3].cId}"><img alt="加载失败"
						...
						<c:if test="${course[4] ne null }">
							<td><a href="${APP_PATH}//upload/testVideo?cId=${course[4].cId}"><img alt="加载失败"
						...
						<c:if test="${course[5] ne null }">
							<td><<a href="${APP_PATH}//upload/testVideo?cId=${course[5].cId}"><img alt="加载失败"
